...
import {
  ...
  Users, TrendingUp, X, Lightbulb, BarChart3,
} from 'lucide-react';
          ...
          <div className="flex gap-2 items-center">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                viewMode === 'weekly' ? 'bg-indigo-500 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              <Calendar size={18} />
              <span>שבועי</span>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                viewMode === 'monthly' ? 'bg-indigo-500 text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
            >
              <Calendar size={18} />
              <span>חודשי</span>
            ...
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 border border-gray-200 rounded-lg">
              ...
              <span className="inline-flex items-center justify-center px-2 py-0.5 bg-indigo-500 text-white rounded-full text-xs font-bold min-w-[22px]">
...
{(viewMode === 'weekly' || viewMode === 'monthly') && (
            <div className="flex gap-2 border-r border-gray-300 pr-4">
              {viewMode === 'weekly' && (
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={todayWeek} className="px-3 py-1.5 text-xs font-semibold bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 border border-indigo-200">
                    היום
                  </button>
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => setShowFilterModal(true)}
              ...
              <Filter size={18} />
              <span className="font-medium">סינון עובדים</span>
              {selectedEmployees.length > 0 && (
