...
// import { Plus, Trash2, X, AlertTriangle, Search } from 'lucide-react';
// import type { EmployeeLink } from '../../../Data/projectsData';



// interface LinkEmployeesToStageModalProps {
//   stageName: string;
...
//     !employees.find(e => e.employeeName === emp)
//   );
...
//     if (employees.find(e => e.employeeName === employeeName)) {
//       setErrorMessage('עובד זה כבר קיים ברשימה');
//       return;
//     }

//     const newEmployee: EmployeeLink = {
//       linkId: 0, // חדש, עדיין לא קיים בבסיס הנתונים
//       id: Date.now(),
//       employeeId: 0, // ייקבע בעת השמירה בבסיס הנתונים
...
//     if (employees.find(e => e.id !== id && e.employeeName === newName)) {
//       setErrorMessage('עובד זה כבר קיים ברשימה');
//       return;
//     }

//     setEmployees(employees.map(emp =>
//       emp.id === id ? { ...emp, employeeName: newName } : emp
//     ));
//     setErrorMessage('');
//   };
...
//   const updateWorkDays = (id: number, value: number) => {
...
//   const updateWorkHours = (id: number, value: number) => {
...
//     setEmployees(employees.map(emp =>
//       emp.id === id ? { ...emp, duration: newDuration } : emp
//     ));
//   };
...
//                       {AVAILABLE_EMPLOYEES
//                         .filter(name => !employees.find(e => e.employeeName === name) || name === emp.employeeName)
//                         .map(name => (
